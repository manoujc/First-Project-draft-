...
Halloween is a well known and celebrated American holiday; it's known mainly for the festivities of dressing in costumes, but also for the childhood aspect of trick-or-treating for candy around the neighborhood. This data set introduced what common traits between ingredients, average price, average win percentage, and average sugar percentage. With this data I could investigate the possibilities of similarities between ingrediants, sugar percentage, win percentage, and average price; is the candy more likely to win because of it's price? Or because of sugar percentage? Or maybe the ingredients?
...
For my visualizations, I analyzed if there was a common trait between the 
